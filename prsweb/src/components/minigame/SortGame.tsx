...
export default function SortGame() {
  ...
  useEffect(() => {
    const handler = (e: KeyboardEvent) => {
      ...
      if (e.key === "Escape") return; // setSelected not exposed — could add if needed
    ...
    <div style={{ position: "relative", minHeight: "100vh", overflow: "hidden", backgroundColor: "#000", ...pixelifySans.style }}>
      ...
      <div style={{ position: "relative", zIndex: 1, minHeight: "100vh" }}>
        ...
        <div style={{ position: "absolute", top: "1rem", left: "1rem", display: "flex", flexDirection: "column", gap: "0.25rem" }}>
          ...
          <span style={{ color: "#6b7280", fontSize: "0.875rem", letterSpacing: "0.1em", fontFamily: shareTechMono.style.fontFamily }}>{formatTime(timer)}</span>
        ...
        {/* Content */}
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", gap: "2rem", padding: "6rem 1rem 2rem" }}>
