  ...
  return (
    <button
      ...
      style={{
        ...
        color: hov ? "#d1d5db" : "#6b7280", transition: "color 0.15s",
      }}
    >
...
export default function Page() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", overflow: "hidden", backgroundColor: "#000000", ...pixelifySans.style }}>
      <Background />
      ...
      <div style={{ position: "relative", zIndex: 1, minHeight: "100vh" }}>
        ...
        <div style={{ position: "absolute", top: "1rem", left: "1rem", display: "flex", flexDirection: "column", gap: "0.25rem" }}>
          ...
          <InfoPopup isOpen={showInfo} onClose={() => setShowInfo(false)} title="Dungeon">
            <p>Navigate the maze with WASD. Entering a new room reveals a Caesar-ciphered description — each room uses its own random shift. Collect all 4 key fragments (each shifted by +2); decode and combine them in order, then enter the result at the exit to escape. Avoid trap rooms.</p>
          </InfoPopup>
